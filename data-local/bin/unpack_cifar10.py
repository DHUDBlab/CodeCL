...
print("dangqiandizhi：",sys.argv);
# ['/home/zhc/code/LP-DeepSSL-master/data-local/bin/unpack_cifar10.py', '/home/zhc/code/LP-DeepSSL-master/data-local/bin/../workdir', '/home/zhc/code/LP-DeepSSL-master/data-local/bin/../images/cifar/cifar10/byimage/']
work_dir = os.path.abspath(sys.argv[1])
test_dir = os.path.abspath(os.path.join(sys.argv[2], 'test'))
train_dir = os.path.abspath(os.path.join(sys.argv[2], 'train+val'))
# torch download dataset
